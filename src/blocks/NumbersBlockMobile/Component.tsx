...
import type { NumbersBlockMobile as NumbersBlockMobileProps } from '@/payload-types';

type Props = NumbersBlockMobileProps & {
  className?: string;
  enableGutter?: boolean;
  disableInnerContainer?: boolean;
};

export const NumbersBlockMobile: React.FC<Props> = ({
  uniqueCourses,
  applicants,
  countriesStates,
  instructors,
